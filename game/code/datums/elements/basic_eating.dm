...
/datum/element/basic_eating/proc/finish_eating(mob/living/eater, atom/target, mob/living/feeder, to_heal)
	set waitfor = FALSE
	if(drinking)
		playsound_if_pref(eater.loc,'../assets/sound/items/drink.ogg', rand(10,50), TRUE, pref_to_check = /datum/preference/toggle/sound_eating) // NOVA EDIT CHANGE - Original: playsound(eater.loc,'../assets/sound/items/drink.ogg', rand(10,50), TRUE)
	else
		playsound_if_pref(eater.loc,'../assets/sound/items/eatfood.ogg', rand(10,50), TRUE, pref_to_check = /datum/preference/toggle/sound_eating) // NOVA EDIT CHANGE - Original: playsound(eater.loc,'../assets/sound/items/eatfood.ogg', rand(10,50), TRUE)
