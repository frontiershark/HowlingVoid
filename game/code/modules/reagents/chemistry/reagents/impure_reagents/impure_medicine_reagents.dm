...
/datum/reagent/inverse/helgrasp/on_mob_add(mob/living/affected_mob, amount)
	...
	playsound(affected_mob.loc, '../assets/sound/effects/chemistry/ahaha.ogg', 80, TRUE, -1) //Very obvious tell so people can be ready
...
/datum/reagent/inverse/penthrite/on_mob_dead(mob/living/carbon/affected_mob, seconds_per_tick, metabolization_ratio)
	...
	affected_mob.playsound_local(affected_mob, '../assets/sound/effects/health/fastbeat.ogg', 65)
