/obj/item/wrench
	...
	operating_sound = list('../assets/sound/items/tools/ratchet_fast.ogg', '../assets/sound/items/tools/ratchet_slow.ogg')
	custom_materials = list(/datum/material/iron=SMALL_MATERIAL_AMOUNT*1.5)
	drop_sound = '../assets/sound/items/handling/tools/wrench_drop.ogg'
	pickup_sound = '../assets/sound/items/handling/tools/wrench_pickup.ogg'
...
/obj/item/wrench/medical/suicide_act(mob/living/user)
	...
	user.set_light(2)
	user.add_overlay(mutable_appearance('../assets/icons/mob/effects/genetics.dmi', "servitude", -MUTATIONS_LAYER))
	playsound(loc, '../assets/sound/effects/pray.ogg', 50, TRUE, -1)
