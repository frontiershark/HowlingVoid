/datum/component/squeak
	var/static/list/default_squeak_sounds = list('../assets/sound/items/toy_squeak/toysqueak1.ogg'=1, '../assets/sound/items/toy_squeak/toysqueak2.ogg'=1, '../assets/sound/items/toy_squeak/toysqueak3.ogg'=1)
