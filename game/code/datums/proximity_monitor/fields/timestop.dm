...
/obj/effect/timestop/Destroy()
	...
	if(!hidden)
		playsound(src, '../assets/sound/effects/magic/timeparadox2.ogg', 75, TRUE, frequency = -1) //reverse!
	return ..()

/obj/effect/timestop/proc/timestop()
	target = get_turf(src)
	if(!hidden)
		playsound(src, '../assets/sound/effects/magic/timeparadox2.ogg', 75, TRUE, -1)
