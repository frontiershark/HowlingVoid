/obj/item/gun/ballistic/automatic/scar
	...
	can_suppress = FALSE
	fire_delay = 2.4
	fire_sound = 'modularhowling_void/modules/ported_content/ark_station/nri_stuff/sound/guns/fire/scar_fire.ogg'
	fire_sound_volume = 50
	rack_sound = 'modularhowling_void/modules/ported_content/ark_station/nri_stuff/sound/guns/interact/scar_cock.ogg'
	load_sound = 'modularhowling_void/modules/ported_content/ark_station/nri_stuff/sound/guns/interact/scar_mag_out.ogg'
