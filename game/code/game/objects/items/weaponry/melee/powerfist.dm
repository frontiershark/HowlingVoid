...
/obj/item/melee/powerfist/attack(mob/living/target, mob/living/user)
	...
	if(!gas_used)
		...
		playsound(loc, '../assets/sound/items/weapons/punch1.ogg', 50, TRUE)
	...
	if(!molar_cmp_equals(gas_used.total_moles(), gas_per_fist * fist_pressure_setting))
		...
		playsound(loc, '../assets/sound/items/weapons/punch4.ogg', 50, TRUE)
	...
	playsound(src, '../assets/sound/items/weapons/resonator_blast.ogg', 50, TRUE)
	playsound(src, '../assets/sound/items/weapons/genhit2.ogg', 50, TRUE)
