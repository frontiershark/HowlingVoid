...
/datum/component/avatar_connection/Initialize(
	...
	avatar.playsound_local(avatar, '../assets/sound/effects/magic/blink.ogg', 25, TRUE)
...
/datum/component/avatar_connection/proc/on_domain_completed(datum/source, atom/entered)
	...
	var/mob/living/avatar = parent
	avatar.playsound_local(avatar, '../assets/sound/machines/terminal/terminal_success.ogg', 50, vary = TRUE)
	avatar.throw_alert(
...
/datum/component/avatar_connection/proc/on_netpod_crowbar(datum/source, mob/living/intruder)
	...
	var/mob/living/avatar = parent
	avatar.playsound_local(avatar, '../assets/sound/machines/terminal/terminal_alert.ogg', 50, vary = TRUE)
