...
GLOBAL_LIST_INIT(achievement_sounds, list(
	CHEEVO_SOUND_PING = sound('../assets/sound/effects/achievement/glockenspiel_ping.ogg', volume = 70),
	CHEEVO_SOUND_JINGLE = sound('../assets/sound/effects/achievement/beeps_jingle.ogg', volume = 70),
	CHEEVO_SOUND_TADA = sound('../assets/sound/effects/achievement/tada_fanfare.ogg', volume = 30),
))
