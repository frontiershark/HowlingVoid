...
/datum/computer_file/program/arcade/proc/game_check(mob/living/user)
	...
	if(boss_hp <= 0)
		...
		playsound(computer.loc, '../assets/sound/machines/arcade/win.ogg', 50)
		game_active = FALSE
		...
		playsound(computer.loc, '../assets/sound/machines/arcade/lose.ogg', 50)
		game_active = FALSE
		program_open_overlay = "arcade_off"
		if(istype(computer))
			computer.update_appearance()
...
/datum/computer_file/program/arcade/proc/enemy_check(mob/living/user)
	...
	if (boss_mp <= 5)
		...
		playsound(computer.loc, '../assets/sound/machines/arcade/steal.ogg', 50, TRUE)
		player_mp -= boss_mpamt
		boss_mp += boss_mpamt
	else if(boss_mp > 5 && boss_hp <12)
		heads_up = "[boss_name] heals for [bossheal] health!"
		playsound(computer.loc, '../assets/sound/machines/arcade/heal.ogg', 50, TRUE)
		boss_hp += bossheal
		boss_mp -= boss_mpamt
	else
		heads_up = "[boss_name] attacks you for [boss_attackamt] damage!"
		playsound(computer.loc, '../assets/sound/machines/arcade/hit.ogg', 50, TRUE)
...
/datum/computer_file/program/arcade/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	...
	switch(action)
		...
		if("Recharge_Power")
			...
			playsound(computer.loc, '../assets/sound/machines/arcade/mana.ogg', 50, TRUE)
