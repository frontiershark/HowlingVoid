...
/datum/gateway_destination/proc/get_available_reason()
	...
	if(world.time - SSticker.round_start_time < wait)
		playsound(src, '../assets/sound/machines/gateway/gateway_calibrating.ogg', 80, TRUE, SHORT_RANGE_SOUND_EXTRARANGE)
...
/obj/effect/gateway_portal_bumper/Bumped(atom/movable/AM)
	...
	if(get_dir(src,AM) == gateway?.dir)
		playsound(src, '../assets/sound/machines/gateway/gateway_travel.ogg', 70, TRUE, SHORT_RANGE_SOUND_EXTRARANGE)
		gateway.Transfer(AM)
...
/obj/machinery/gateway
	...
	icon = '../assets/icons/obj/machines/gateway.dmi'
...
/obj/machinery/gateway/proc/deactivate()
	...
	target = null
	playsound(src, '../assets/sound/machines/gateway/gateway_close.ogg', 140, TRUE, TRUE, SOUND_RANGE)
	dest.deactivate(src)
	QDEL_NULL(portal)
...
/obj/machinery/gateway/proc/show_light_overlays(light_state, toggle)
	...
	to_animate += image('../assets/icons/obj/machines/gateway.dmi', light_state)
	var/image/glowing_light = image('../assets/icons/obj/machines/gateway.dmi', light_state)
...
/obj/machinery/gateway/proc/activate(datum/gateway_destination/D)
	...
	playsound(src, '../assets/sound/machines/gateway/gateway_open.ogg', 140, TRUE, TRUE, SOUND_RANGE)
	generate_bumper()
...
/obj/machinery/gateway/multitool_act(mob/living/user, obj/item/I)
	if(calibrated)
		...
		playsound(src, '../assets/sound/machines/gateway/gateway_calibrated.ogg', 80, TRUE, SHORT_RANGE_SOUND_EXTRARANGE)
