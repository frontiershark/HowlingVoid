...
/datum/dynamic_ruleset/midround/from_ghosts/proc/prompt_namechange(mob/living/player, client/player_client)
	...
	player.playsound_local(player, '../assets/sound/machines/terminal/terminal_prompt.ogg', 50, FALSE)
	...
	switch(tgui_alert(
		...
		if("Operative alias")
			...
			player.playsound_local(player, '../assets/sound/machines/terminal/terminal_prompt_confirm.ogg', 50, FALSE)
		...
		if("Random alias")
			...
			player.playsound_local(player, '../assets/sound/machines/terminal/terminal_prompt_deny.ogg', 50, FALSE)
