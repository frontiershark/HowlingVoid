...
/obj/structure/ethereal_crystal/Initialize(mapload, obj/item/organ/heart/ethereal/ethereal_heart)
	...
	playsound(get_turf(src), '../assets/sound/mobs/humanoids/ethereal/ethereal_crystalization.ogg', 50)
...
/obj/structure/ethereal_crystal/atom_destruction(damage_flag)
	playsound(get_turf(ethereal_heart.owner), '../assets/sound/mobs/humanoids/ethereal/ethereal_revive_fail.ogg', 100)
	return ..()
...
/obj/structure/ethereal_crystal/proc/heal_ethereal()
	...
	playsound(get_turf(regenerating), '../assets/sound/mobs/humanoids/ethereal/ethereal_revive.ogg', 100)
