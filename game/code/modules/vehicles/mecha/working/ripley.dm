/obj/vehicle/sealed/mecha/ripley
	...
	stepsound = '../assets/sound/vehicles/mecha/powerloader_step.ogg'
	turnsound = '../assets/sound/vehicles/mecha/powerloader_turn2.ogg'
...
/obj/item/mecha_parts/mecha_equipment/ejector/seccage/container_resist_act(mob/living/user)
	...
	playsound(chassis, '../assets/sound/items/tools/crowbar.ogg', 100, TRUE)
	cheese_it(user)
