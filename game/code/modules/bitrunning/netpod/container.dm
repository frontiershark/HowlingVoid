...
/obj/machinery/netpod/open_machine(drop = TRUE, density_to_set = FALSE)
	playsound(src, '../assets/sound/machines/tram/tramopen.ogg', 60, TRUE, frequency = 65000)
...
/obj/machinery/netpod/close_machine(mob/user, density_to_set = TRUE)
	...
	playsound(src, '../assets/sound/machines/tram/tramclose.ogg', 60, TRUE, frequency = 65000)
