...
/datum/heretic_knowledge/hunt_and_sacrifice
	...
	research_tree_icon_path = '../assets/icons/effects/eldritch.dmi'
...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/grant_reward(mob/living/user, mob/living/sacrifice, turf/loc)
	...
	playsound(sacrifice, '../assets/sound/effects/magic/disintegrate.ogg', 75, TRUE)
...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/deposit_reward(mob/user, turf/loc, loop = 0, obj/rune)
	...
	playsound(loc, '../assets/sound/effects/magic/repulse.ogg', 75, TRUE)
	var/datum/antagonist/heretic/heretic_datum = GET_HERETIC(user)
...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/after_target_sleeps(mob/living/carbon/human/sac_target, turf/destination)
	...
	if(!destination || !do_teleport(sac_target, destination, asoundin = '../assets/sound/effects/magic/repulse.ogg', asoundout = '../assets/sound/effects/magic/blind.ogg', no_effects = TRUE, channel = TELEPORT_CHANNEL_MAGIC, forced = TRUE))
		disembowel_target(sac_target)
		return
	...
	playsound(sac_target, '../assets/sound/music/antag/heretic/heretic_sacrifice.ogg', 50, FALSE) // play theme
...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/return_target(mob/living/carbon/human/sac_target)
	...
	if(!do_teleport(sac_target, safe_turf, asoundout = '../assets/sound/effects/magic/blind.ogg', no_effects = TRUE, channel = TELEPORT_CHANNEL_MAGIC, forced = TRUE))
		safe_turf = get_turf(backup_loc)
