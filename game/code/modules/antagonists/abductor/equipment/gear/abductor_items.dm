/obj/item/abductor
	...
	lefthand_file = '../assets/icons/mob/inhands/antag/abductor_lefthand.dmi'
	righthand_file = '../assets/icons/mob/inhands/antag/abductor_righthand.dmi'
...
/obj/item/melee/baton/abductor/proc/toggle(mob/living/user=usr)
	...
	on_stun_sound = is_stun_or_sleep ? '../assets/sound/items/weapons/egloves.ogg' : null
...
/obj/item/abductor_machine_beacon/attack_self(mob/user)
	...
	playsound(src, '../assets/sound/machines/terminal/terminal_alert.ogg', 50)
	...
	if(isfloorturf(loc))
		...
		for(var/obj/thing in T.contents)
			if(thing.density || ismachinery(thing) || isstructure(thing))
				viable = FALSE
	if(viable)
		playsound(src, '../assets/sound/effects/phasein.ogg', 50, TRUE)
		var/new_machine = new spawned_machine(loc)
		visible_message(span_notice("[new_machine] warps on top of the beacon!"))
		qdel(src)
	else
		playsound(src, '../assets/sound/machines/buzz/buzz-two.ogg', 50)
...
/obj/item/abductor/alien_omnitool/proc/set_toolset(mob/user)
	if(active_toolset == TOOLSET_MEDICAL)
		tool_list = list(
			"Crowbar" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "crowbar"),
			"Multitool" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "multitool"),
			"Screwdriver" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "screwdriver_a"),
			"Wirecutters" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "cutters"),
			"Wrench" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "wrench"),
			"Welding Tool" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "welder"),
		)
		...
		tool_list = list(
			"Retractor" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "retractor"),
			"Hemostat" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "hemostat"),
			"Cautery" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "cautery"),
			"Drill" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "drill"),
			"Scalpel" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "scalpel"),
			"Saw" = image(icon = '../assets/icons/obj/antags/abductor.dmi', icon_state = "saw"),
			"Bonesetter" = image(icon = '../assets/icons/obj/medical/surgery_tools.dmi', icon_state = "bonesetter"),
			"Blood Filter" = image(icon = '../assets/icons/obj/medical/surgery_tools.dmi', icon_state = "bloodfilter"),
		)
