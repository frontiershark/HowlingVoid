...
/datum/grand_finale/cheese/trigger(mob/living/invoker)
	...
	priority_announce("Danger: Extremely potent reality altering object has been summoned on station. Immediate evacuation advised. Brace for impact.", "[command_name()] Higher Dimensional Affairs", '../assets/sound/effects/glass/glassbr1.ogg')
