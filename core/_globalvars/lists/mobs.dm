...
GLOBAL_LIST_INIT(construct_radial_images, list(
	CONSTRUCT_JUGGERNAUT = image(icon = '../assets/icons/mob/nonhuman-player/cult.dmi', icon_state = "juggernaut"),
	CONSTRUCT_WRAITH = image(icon = '../assets/icons/mob/nonhuman-player/cult.dmi', icon_state = "wraith"),
	CONSTRUCT_ARTIFICER = image(icon = '../assets/icons/mob/nonhuman-player/cult.dmi', icon_state = "artificer")
))
