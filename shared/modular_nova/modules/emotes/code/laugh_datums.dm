...
/datum/laugh_type/human
	name = "Human Laugh"
	male_laughsounds = list('../assets/sound/mobs/humanoids/human/laugh/manlaugh1.ogg',,
...
/datum/laugh_type/moth
	...
	male_laughsounds = list('../assets/sound/mobs/humanoids/moth/moth_laugh1.ogg')
	female_laughsounds = null

/datum/laugh_type/lizard
	name = "Lizard Laugh"
	male_laughsounds = list('../assets/sound/mobs/humanoids/lizard/lizard_laugh1.ogg')
	female_laughsounds = null
