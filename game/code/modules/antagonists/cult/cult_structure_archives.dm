...
/obj/structure/destructible/cult/item_dispenser/archives/setup_options()
	var/static/list/archive_items = list(
		CULT_BLINDFOLD = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/obj/clothing/glasses.dmi', icon_state = "blindfold"),
		...
		CURSE_ORB = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/obj/antags/cult/items.dmi', icon_state = "shuttlecurse"),
		...
		VEIL_WALKER = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/obj/antags/cult/items.dmi', icon_state = "shifter"),
...
/obj/structure/destructible/cult/item_dispenser/archives/extra_options()
	...
	return list(CRIMSON_MEDALLION = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/obj/clothing/neck.dmi', icon_state = "crimson_medallion"),
