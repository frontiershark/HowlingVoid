/obj/item/mecha_parts/mecha_equipment/weapon
	...
	destroy_sound = '../assets/sound/vehicles/mecha/weapdestr.ogg'
...
/obj/item/mecha_parts/mecha_equipment/weapon/energy/pulse
	...
	fire_sound = '../assets/sound/items/weapons/marauder.ogg'
	harmful = TRUE
...
/obj/item/mecha_parts/mecha_equipment/weapon/honker/action(mob/source, atom/target, list/modifiers)
	if(!action_checks(target))
		return
	playsound(chassis, '../assets/sound/items/airhorn/airhorn.ogg', 100, TRUE)
