/obj/item/screwdriver
	...
	usesound = list('../assets/sound/items/tools/screwdriver.ogg', '../assets/sound/items/tools/screwdriver2.ogg')
	operating_sound = '../assets/sound/items/tools/screwdriver_operating.ogg'
...
/obj/item/screwdriver/abductor/get_belt_overlay()
	return mutable_appearance('../assets/icons/obj/clothing/belt_overlays.dmi', "screwdriver_alien")
...
/obj/item/screwdriver/power/proc/on_transform(obj/item/source, mob/user, active)
	...
	playsound(src, '../assets/sound/items/tools/change_drill.ogg', 50, TRUE)
...
/obj/item/screwdriver/power/suicide_act(mob/living/user)
	...
	playsound(loc, '../assets/sound/items/tools/drill_use.ogg', 50, TRUE, -1)
	return BRUTELOSS
