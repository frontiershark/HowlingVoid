...
/obj/structure/destructible/cult/item_dispenser/altar/setup_options()
	var/static/list/altar_items = list(
		ELDRITCH_WHETSTONE = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/obj/antags/cult/items.dmi', icon_state = "cult_sharpener"),
		...
		CONSTRUCT_SHELL = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/mob/shells.dmi', icon_state = "construct_cult"),
		...
		UNHOLY_WATER = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/obj/drinks/bottles.dmi', icon_state = "unholyflask"),
...
/obj/structure/destructible/cult/item_dispenser/altar/extra_options()
	...
	return list(PROTEON_ORB = list(
			PREVIEW_IMAGE = image(icon = '../assets/icons/obj/antags/cult/items.dmi', icon_state = "summoning_orb"),
