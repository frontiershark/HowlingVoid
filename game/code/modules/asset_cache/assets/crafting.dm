...
/datum/asset/spritesheet_batched/crafting/proc/add_tool_icons()
	var/list/tool_icons = list(
		TOOL_CROWBAR = uni_icon('../assets/icons/obj/tools.dmi', "crowbar"),
		TOOL_MULTITOOL = uni_icon('../assets/icons/obj/devices/tool.dmi', "multitool"),
		TOOL_SCREWDRIVER = uni_icon('../assets/icons/map_icons/items/_item.dmi', "/obj/item/screwdriver"),
		TOOL_WIRECUTTER = uni_icon('../assets/icons/obj/tools.dmi', "cutters_map"),
		TOOL_WRENCH = uni_icon('../assets/icons/obj/tools.dmi', "wrench"),
		TOOL_WELDER = uni_icon('../assets/icons/obj/tools.dmi', "welder"),
		TOOL_ANALYZER = uni_icon('../assets/icons/obj/devices/scanner.dmi', "analyzer"),
		TOOL_MINING = uni_icon('../assets/icons/obj/mining.dmi', "minipick"),
		TOOL_SHOVEL = uni_icon('../assets/icons/obj/mining.dmi', "spade"),
		TOOL_RETRACTOR = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "retractor"),
		TOOL_HEMOSTAT = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "hemostat"),
		TOOL_CAUTERY = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "cautery"),
		TOOL_DRILL = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "drill"),
		TOOL_SCALPEL = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "scalpel"),
		TOOL_SAW = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "saw"),
		TOOL_BONESET = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "bonesetter"),
		TOOL_KNIFE = uni_icon('../assets/icons/obj/service/kitchen.dmi', "knife"),
		TOOL_BLOODFILTER = uni_icon('../assets/icons/obj/medical/surgery_tools.dmi', "bloodfilter"),
		TOOL_ROLLINGPIN = uni_icon('../assets/icons/obj/service/kitchen.dmi', "rolling_pin"),
		TOOL_RUSTSCRAPER = uni_icon('../assets/icons/obj/tools.dmi', "wirebrush"),
	)
