/datum/blooper/synthetic_grunt
	...
	id = "synthgrunt"
	soundpath = '../assets/sound/misc/bloop.ogg'

/datum/blooper/synthetic
	name = "Synthetic (Normal)"
	id = "synth"
	soundpath = '../assets/sound/machines/uplink/uplinkerror.ogg'

/datum/blooper/coggers
	name = "Brassy"
	id = "coggers"
	soundpath = '../assets/sound/machines/clockcult/integration_cog_install.ogg'
...
/datum/blooper/blub
	name = "Blub"
	id = "blub"
	soundpath = '../assets/goon/sounds/blub.ogg'

/datum/blooper/bottalk
	name = "Bottalk 1"
	id = "bottalk1"
	soundpath = '../assets/goon/sounds/bottalk_1.ogg'
	minspeed = 3
	maxspeed = 9
...
/datum/blooper/bottalk/alt1
	name = "Bottalk 2"
	id = "bottalk2"
	soundpath = '../assets/goon/sounds/bottalk_2.ogg'

/datum/blooper/bottalk/alt2
	name = "Bottalk 3"
	id = "bottalk3"
	soundpath = '../assets/goon/sounds/bottalk_3.ogg'

/datum/blooper/bottalk/alt3
	name = "Bottalk 4"
	id = "bottalk4"
	soundpath = '../assets/goon/sounds/bottalk_4.ogg'

/datum/blooper/buwoo
	name = "Buwoo"
	id = "buwoo"
	soundpath = '../assets/goon/sounds/buwoo.ogg'

/datum/blooper/cow
	name = "Cow"
	id = "cow"
	soundpath = '../assets/goon/sounds/cow.ogg'

/datum/blooper/lizard
	name = "Lizard"
	id = "lizard"
	soundpath = '../assets/goon/sounds/lizard.ogg'

/datum/blooper/pug
	name = "Pug"
	id = "pug"
	soundpath = '../assets/goon/sounds/pug.ogg'

/datum/blooper/pugg
	name = "Pugg"
	id = "pugg"
	soundpath = '../assets/goon/sounds/pugg.ogg'

/datum/blooper/radio
	name = "Radio 1"
	id = "radio1"
	soundpath = '../assets/goon/sounds/radio.ogg'

/datum/blooper/radio/short
	name = "Radio 2"
	id = "radio2"
	soundpath = '../assets/goon/sounds/radio2.ogg'

/datum/blooper/radio/ai
	name = "Radio (AI)"
	id = "radio_ai"
	soundpath = '../assets/goon/sounds/radio_ai.ogg'

/datum/blooper/roach //Turkish characters be like
	name = "Roach"
	id = "roach"
	soundpath = '../assets/goon/sounds/roach.ogg'

/datum/blooper/skelly
	name = "Skelly"
	id = "skelly"
	soundpath = '../assets/goon/sounds/skelly.ogg'

/datum/blooper/speak
	name = "Speak 1"
	id = "speak1"
	soundpath = '../assets/goon/sounds/speak_1.ogg'

/datum/blooper/speak/alt1
	name = "Speak 2"
	id = "speak2"
	soundpath = '../assets/goon/sounds/speak_2.ogg'

/datum/blooper/speak/alt2
	name = "Speak 3"
	id = "speak3"
	soundpath = '../assets/goon/sounds/speak_3.ogg'

/datum/blooper/speak/alt3
	name = "Speak 4"
	id = "speak4"
	soundpath = '../assets/goon/sounds/speak_4.ogg'
