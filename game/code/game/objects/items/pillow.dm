...
/obj/item/pillow
	...
	lefthand_file = '../assets/icons/mob/inhands/items/pillow_lefthand.dmi'
	righthand_file = '../assets/icons/mob/inhands/items/pillow_righthand.dmi'
	force = 5
...
/obj/item/pillow/attack(mob/living/carbon/target_mob, mob/living/user, list/modifiers, list/attack_modifiers)
	...
	if(bricked || HAS_TRAIT(src, TRAIT_WIELDED))
		hit_sound = '../assets/sound/items/pillow/pillow_hit2.ogg'
	else
		hit_sound = '../assets/sound/items/pillow/pillow_hit.ogg'
...
/obj/item/pillow/click_alt(mob/user)
	...
	playsound(user,'../assets/sound/items/poster/poster_ripped.ogg', 50)
	update_appearance()
...
/obj/item/clothing/suit/pillow_suit
	...
	icon = '../assets/icons/obj/bed.dmi'
	worn_icon = '../assets/icons/mob/clothing/suits/pillow.dmi'
