...
/obj/item/paper/paperslip/ration_ticket/proc/try_to_make_ration_order_list(obj/machinery/computer/cargo/object_we_attack, mob/living/user)
	...
	playsound(object_we_attack, '../assets/sound/machines/terminal/terminal_insert_disc.ogg', 50, FALSE)
...
/obj/item/paper/paperslip/ration_ticket/luxury/try_to_make_ration_order_list(obj/machinery/computer/cargo/object_we_attack, mob/living/user)
	...
	var/list/radial_consumables_options = list(
		"Cigarettes" = image(icon = '../assets/icons/obj/cigarettes.dmi', icon_state = "robust"),
		"Coffee Powder" = image(icon = '../assets/icons/obj/food/cartridges.dmi', icon_state = "cartridge_blend"),
		"Tea Powder" = image(icon = '../assets/icons/obj/service/hydroponics/harvest.dmi', icon_state = "tea_aspera_leaves"),
	)
