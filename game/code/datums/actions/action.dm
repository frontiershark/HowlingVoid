...
/datum/action
	...
	var/background_icon = '../assets/icons/mob/actions/backgrounds.dmi'
	...
	var/button_icon = '../assets/icons/hud/actions.dmi'
	...
	var/overlay_icon = '../assets/icons/mob/actions/backgrounds.dmi'
