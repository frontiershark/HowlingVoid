...
/datum/component/spin2win/proc/start_spinning(mob/living/spinning_user)
	...
	playsound(spinning_user, '../assets/sound/items/weapons/fwoosh.ogg', 75, FALSE)
...
/datum/component/spin2win/proc/stop_spinning(mob/living/user)
	...
	playsound(user, '../assets/sound/items/weapons/fwoosh.ogg', 75, FALSE)
...
/datum/component/spin2win/process(seconds_per_tick)
	...
	playsound(item_owner, '../assets/sound/items/weapons/fwoosh.ogg', 75, FALSE)
