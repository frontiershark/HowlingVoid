...
/datum/surgery_operation/limb/add_plastic
	...
	preop_sound = '../assets/sound/effects/blob/blobattack.ogg'
	success_sound = '../assets/sound/effects/blob/attackblob.ogg'
	failure_sound = '../assets/sound/effects/blob/blobattack.ogg'
	all_surgery_states_required = SURGERY_SKIN_OPEN
