...
/datum/component/stove/proc/toggle_mode()
	...
	playsound(real_parent, '../assets/sound/machines/click.ogg', 30, TRUE)
	playsound(real_parent, on ? '../assets/sound/items/tools/welderactivate.ogg' : '../assets/sound/items/tools/welderdeactivate.ogg', 15, TRUE)
