...
/area/ruin/powered/miningfacility
	...
	ambientsounds = list('../assets/sound/music/lobby_music/title3.ogg') //Classic vibes

/area/ruin/powered/crashedshuttle
	name = "Crashed Shuttle"
	icon_state = "dk_yellow"
	ambientsounds = list('../assets/sound/ambience/misc/ambiodd.ogg')

/area/ruin/powered/cozycabin
	name = "Cozy Cabin"
	icon_state = "dk_yellow"
	ambientsounds = list('../assets/sound/ambience/holy/ambicha1.ogg', '../assets/sound/ambience/holy/ambicha2.ogg', '../assets/sound/ambience/holy/ambicha3.ogg')
...
/area/ruin/unpowered/magic_hotsprings
	...
	icon_state = "ruins"
	ambientsounds = list('../assets/sound/ambience/icemoon/ambiicemelody2.ogg')

/area/ruin/unpowered/abandoned_hearth
	name = "Abandoned Hearth"
	icon_state = "ruins"
	ambientsounds = list('../assets/sound/ambience/icemoon/ambiicesting4.ogg', '../assets/sound/ambience/icemoon/ambiicemelody1.ogg')

/area/ruin/unpowered/abandoned_sacred_temple
	name = "Abandoned Sacred Temple"
	icon_state = "ruins"
	ambientsounds = list('../assets/sound/ambience/holy/ambiholy.ogg')
