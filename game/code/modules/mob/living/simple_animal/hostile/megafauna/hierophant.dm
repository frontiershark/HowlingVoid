...
/mob/living/simple_animal/hostile/megafauna/hierophant
	...
	icon = '../assets/icons/mob/simple/lavaland/hierophant_new.dmi'
...
/mob/living/simple_animal/hostile/megafauna/hierophant/Initialize(mapload)
	...
	AddComponent(/datum/component/boss_music, '../assets/sound/music/boss/hiero_boss.ogg', COMSIG_HOSTILE_FOUND_TARGET) // change to COMSIG_AI_BLACKBOARD_KEY_SET(BB_BASIC_MOB_CURRENT_TARGET) in basic conversion
...
/mob/living/simple_animal/hostile/megafauna/hierophant/proc/blasts(mob/victim, list/directions = GLOB.cardinals) //fires cross blasts with a delay
	...
	playsound(T, '../assets/sound/effects/bin/bin_close.ogg', 75, TRUE)
...
/mob/living/simple_animal/hostile/megafauna/hierophant/proc/blink(mob/victim) //blink to a target
	...
	playsound(T,'../assets/sound/effects/magic/wand_teleport.ogg', 80, TRUE)
	playsound(source,'../assets/sound/machines/airlock/airlockopen.ogg', 80, TRUE)
	blinking = TRUE
...
/proc/hierophant_burst(mob/caster, turf/original, burst_range, spread_speed = 0.5)
	playsound(original,'../assets/sound/machines/airlock/airlockopen.ogg', 750, TRUE)
	var/last_dist = 0
...
/mob/living/simple_animal/hostile/megafauna/hierophant/Moved(atom/old_loc, movement_dir, forced, list/old_locs, momentum_change = TRUE)
	...
	if(!stat && .)
		...
		playsound(src, '../assets/sound/vehicles/mecha/mechmove04.ogg', 80, TRUE, -4)
		if(target)
			arena_trap(target)
...
/obj/effect/temp_visual/hierophant/blast/damaging/proc/blast()
	...
	if(!T)
		return
	playsound(T,'../assets/sound/effects/magic/blind.ogg', 65, TRUE, -5) //make a sound
...
/obj/effect/temp_visual/hierophant/blast/damaging/proc/do_damage(turf/T)
	...
	for(var/mob/living/L in T.contents - hit_things) //find and damage mobs...
		...
		playsound(L,'../assets/sound/items/weapons/sear.ogg', 50, TRUE, -4)
	...
	for(var/obj/vehicle/sealed/mecha/M in T.contents - hit_things) //also damage mechs.
		...
		for(var/O in M.occupants)
			...
			playsound(M,'../assets/sound/items/weapons/sear.ogg', 50, TRUE, -4)
...
/obj/effect/temp_visual/hierophant/blast/visual/Initialize(mapload, new_caster)
	...
	playsound(src_turf,'../assets/sound/effects/magic/blind.ogg', 65, TRUE, -5)
	...
	if(istype(attacking_item, /obj/item/hierophant_club))
		...
		if(club.beacon == src)
			...
			if(do_after(user, 5 SECONDS, target = src))
				playsound(src,'../assets/sound/effects/magic/blind.ogg', 100, TRUE, -4)
