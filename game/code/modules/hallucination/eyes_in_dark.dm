...
/obj/effect/abstract/floating_eyes/update_overlays()
	. = ..()
	var/mutable_appearance/r_eye = mutable_appearance(icon = '../assets/icons/mob/human/human_eyes.dmi', icon_state = "eyes_glow_r")
	r_eye.color = COLOR_DARK_RED
	. += r_eye
	var/mutable_appearance/l_eye = mutable_appearance(icon = '../assets/icons/mob/human/human_eyes.dmi', icon_state = "eyes_glow_l")
	l_eye.color = COLOR_DARK_RED
	. += l_eye

	. += emissive_appearance('../assets/icons/mob/human/human_eyes.dmi', "eyes_glow_l", src)
	. += emissive_appearance('../assets/icons/mob/human/human_eyes.dmi', "eyes_glow_r", src)
