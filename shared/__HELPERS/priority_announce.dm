...
/proc/minor_announce(message, title = "Attention:", alert = FALSE, html_encode = TRUE, list/players, sound_override, should_play_sound = TRUE, color_override)
	...
	var/custom_sound = sound_override || (alert ? 'modular_nova/modules/alerts/sound/alerts/alert1.ogg' : '../assets/sound/announcer/notice/notice2.ogg') // NOVA EDIT CHANGE - CUSTOM ANNOUNCEMENTS - Original: var/custom_sound = sound_override || (alert ? '../assets/sound/announcer/notice/notice1.ogg' : '../assets/sound/announcer/notice/notice2.ogg')
...
/proc/dispatch_announcement_to_players(announcement, list/players = GLOB.player_list, sound_override = null, should_play_sound = TRUE)
	...
	var/sound_to_play = !isnull(sound_override) ? sound_override : '../assets/sound/announcer/notice/notice2.ogg'
