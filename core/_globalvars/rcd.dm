...
/proc/init_holographic_wall()
	return icon('../assets/icons/turf/walls/wall.dmi', "wall-0")

/proc/init_holographic_window()
	var/icon/grille_icon = icon('../assets/icons/obj/structures.dmi', "grille")
	var/icon/window_icon = icon('../assets/icons/obj/smooth_structures/window.dmi', "window-0")
