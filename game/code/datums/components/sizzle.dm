...
/datum/component/sizzle/Initialize(grilled_time)
	...
	grill_marks.Blend(icon('../assets/icons/obj/machines/kitchen.dmi', "grillmarks"), ICON_MULTIPLY) //adds grill marks and the remaining white areas become transparent
