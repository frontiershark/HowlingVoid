...
/datum/sm_delam/proc/effect_demoralize(obj/machinery/power/supermatter_crystal/sm)
	...
	for(var/mob/victim as anything in GLOB.player_list)
		...
		if(!is_valid_z_level(victim_turf, sm_turf))
			continue
		victim.playsound_local(victim_turf, '../assets/sound/effects/magic/charge.ogg')
	...
	*/
	...
	if(SSshuttle.emergency.mode != SHUTTLE_ESCAPE)
		priority_announce(
			...
			sound = ANNOUNCER_SHUTTLE, // NOVA EDIT CHANGE - Announcer Sounds - ORIGINAL: sound =  '../assets/sound/announcer/announcement/announce_dig.ogg',
...
/datum/sm_delam/proc/effect_cascade_demoralize()
	for(var/mob/player as anything in GLOB.player_list)
		...
		SEND_SOUND(player, '../assets/sound/effects/magic/charge.ogg')
