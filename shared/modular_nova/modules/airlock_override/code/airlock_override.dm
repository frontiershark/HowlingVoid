...
/proc/toggle_eng_override()
	if(!GLOB.force_eng_override)
		...
		minor_announce("Engineering staff will have expanded access to areas of the station during the emergency.", "Engineering Emergency", sound_override = '../assets/sound/announcer/notice/notice1.ogg')
