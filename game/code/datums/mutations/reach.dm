...
/datum/mutation/telekinesis/New(datum/mutation/copymut)
	...
	if(!(type in visual_indicators))
		visual_indicators[type] = list(mutable_appearance('modular_nova/master_files/icons/effects/tele_effects.dmi', "telekinesishead", -MUTATIONS_LAYER)) //NOVA EDIT CHANGE - ORIGINAL: visual_indicators[type] = list(mutable_appearance('../assets/icons/mob/effects/genetics.dmi', "telekinesishead", -MUTATIONS_LAYER))
