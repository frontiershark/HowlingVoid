...
/datum/component/regenerative_shield/proc/block_attack(
	...
	playsound(get_turf(parent), '../assets/sound/items/weapons/tap.ogg', 20)
...
/datum/component/regenerative_shield/proc/disable_shield()
	...
	playsound(parent, '../assets/sound/vehicles/mecha/mech_shield_drop.ogg', 20)
...
/datum/component/regenerative_shield/proc/enable_shield()
	...
	playsound(parent, '../assets/sound/vehicles/mecha/mech_shield_raise.ogg', 20)
