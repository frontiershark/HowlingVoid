/obj/item/mecha_ammo
	...
	icon = '../assets/icons/obj/weapons/guns/mecha_ammo.dmi'
	icon_state = "empty"
	...
	var/load_audio = '../assets/sound/items/weapons/gun/general/mag_bullet_insert.ogg'
	var/ammo_type
...
/obj/item/mecha_ammo/missiles_srm
	...
	rounds = 8
	direct_load = TRUE
	load_audio = '../assets/sound/items/weapons/gun/general/mag_bullet_insert.ogg'
