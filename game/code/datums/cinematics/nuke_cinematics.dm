...
/datum/cinematic/nuke/fake/play_nuke_effect()
	play_cinematic_sound(sound('../assets/sound/items/bikehorn.ogg'))
...
/datum/cinematic/nuke/clown/play_nuke_effect()
	play_cinematic_sound(sound('../assets/sound/items/airhorn/airhorn.ogg'))
	flick("summary_selfdes", screen) //???
...
/datum/cinematic/nuke/no_core/play_nuke_effect()
	...
	play_cinematic_sound(sound('../assets/sound/ambience/misc/signal.ogg'))
	stoplag(10 SECONDS)
