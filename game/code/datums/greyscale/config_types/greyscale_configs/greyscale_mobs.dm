...
/datum/greyscale_config/carp
	name = "Space Carp"
	icon_file = '../assets/icons/mob/simple/carp.dmi'
...
/datum/greyscale_config/carp_mega
	name = "Megacarp"
	icon_file = '../assets/icons/mob/simple/broadMobs.dmi'
