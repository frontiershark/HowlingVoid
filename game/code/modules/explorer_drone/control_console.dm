...
/obj/machinery/computer/exodrone_control_console/proc/start_drone_control(obj/item/exodrone/drone)
	if(!drone.controlled)//Only one controller per drone at once to make it saner
		...
		update_icon()
		playsound(src, '../assets/sound/machines/terminal/terminal_on.ogg', 20, vary = TRUE)
...
/obj/machinery/computer/exodrone_control_console/proc/on_exodrone_status_changed()
	...
	playsound(src, '../assets/sound/machines/terminal/terminal_processing.ogg', 20, vary = TRUE)
	update_icon()

/obj/machinery/computer/exodrone_control_console/proc/drone_destroyed()
	SIGNAL_HANDLER
	signal_lost = TRUE
	playsound(src, '../assets/sound/machines/terminal/terminal_alert.ogg', 20, vary = TRUE)
	end_drone_control()
...
/obj/machinery/computer/exodrone_control_console/proc/end_drone_control()
	if(controlled_drone)
		...
		update_icon()
		playsound(src, '../assets/sound/machines/terminal/terminal_off.ogg', 20, vary = TRUE)
