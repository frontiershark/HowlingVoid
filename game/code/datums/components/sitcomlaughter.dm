/datum/component/wearertargeting/sitcomlaughter
	...
	var/list/comedysounds = list('../assets/sound/items/sitcom_laugh/sitcomLaugh1.ogg', '../assets/sound/items/sitcom_laugh/sitcomLaugh2.ogg', '../assets/sound/items/sitcom_laugh/sitcomLaugh3.ogg')
