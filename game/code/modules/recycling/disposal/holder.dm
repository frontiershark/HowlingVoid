...
/obj/structure/disposalholder/proc/struggle_free(mob/living/escapee)
	...
	playsound(loc, '../assets/sound/machines/airlock/airlock_alien_prying.ogg', vol = 30, vary = FALSE, extrarange = 3) //yeah I know but at least it sounds like metal being bent.
...
/obj/structure/disposalholder/relaymove(mob/living/user, direction)
	...
	playsound(src.loc, '../assets/sound/effects/clang.ogg', 50, FALSE, FALSE)
