// SHADEKIN //
#define BODYPART_ICON_SHADEKIN 'modularhowling_void/modules/modular_species/species/shadekin/icons/human_parts_greyscale.dmi'
...
/obj/item/bodypart/head/shadekin
	...
	brute_modifier = 1.2
	burn_modifier = 1.2
	eyes_icon = 'modularhowling_void/modules/modular_species/species/shadekin/icons/shadekin_eyes.dmi'
