...
/obj/item/fireaxe/energy/Initialize(mapload)
	...
	AddComponent(/datum/component/two_handed, force_unwielded = 10, force_wielded = 33, icon_wielded = "[base_icon_state]1", wieldsound = '../assets/sound/items/weapons/saberon.ogg', unwieldsound = '../assets/sound/items/weapons/saberoff.ogg')
