/obj/item/gun/ballistic/automatic/pistol
	...
	fire_sound = '../assets/sound/items/weapons/gun/pistol/shot.ogg'
	dry_fire_sound = '../assets/sound/items/weapons/gun/pistol/dry_fire.ogg'
	suppressed_sound = '../assets/sound/items/weapons/gun/pistol/shot_suppressed.ogg'
	load_sound = '../assets/sound/items/weapons/gun/pistol/mag_insert.ogg'
	load_empty_sound = '../assets/sound/items/weapons/gun/pistol/mag_insert.ogg'
	eject_sound = '../assets/sound/items/weapons/gun/pistol/mag_release.ogg'
	eject_empty_sound = '../assets/sound/items/weapons/gun/pistol/mag_release.ogg'
	rack_sound = '../assets/sound/items/weapons/gun/pistol/rack_small.ogg'
	lock_back_sound = '../assets/sound/items/weapons/gun/pistol/lock_small.ogg'
	bolt_drop_sound = '../assets/sound/items/weapons/gun/pistol/drop_small.ogg'
	drop_sound = '../assets/sound/items/handling/gun/ballistics/pistol/pistol_drop1.ogg'
	pickup_sound = '../assets/sound/items/handling/gun/ballistics/pistol/pistol_pickup1.ogg'
...
/obj/item/gun/ballistic/automatic/pistol/m1911
	...
	can_suppress = FALSE
	fire_sound = '../assets/sound/items/weapons/gun/pistol/shot_alt.ogg'
...
/obj/item/gun/ballistic/automatic/pistol/doorhickey/unload_ammo(mob/living/user, forced = FALSE)
	...
	playsound(user, '../assets/sound/items/tools/screwdriver_operating.ogg', 75, FALSE, MEDIUM_RANGE_SOUND_EXTRARANGE)
