...
/obj/machinery/trading_card_holder/attack_hand(mob/user)
	if(current_summon)
		...
		if(!length(choices))
			...
			"Mark" = image(icon = '../assets/icons/hud/radial.dmi', icon_state = "radial_mark"),
			"Modify" = image(icon = '../assets/icons/hud/radial.dmi', icon_state = "radial_modify"),
			)
...
/obj/structure/trading_card_summon
	name = "coder"
	icon = '../assets/icons/obj/toys/tcgsummons.dmi'
	icon_state = "hologram"
	anchored = TRUE
...
/obj/structure/trading_card_summon/update_overlays()
	...
	if(marked)
		var/mutable_appearance/mark_overlay = mutable_appearance('../assets/icons/obj/toys/tcgmisc.dmi', "gem_green", 9)
...
/obj/structure/trading_card_summon/blank/load_model()
	...
	hologram.icon = '../assets/icons/obj/toys/tcgmisc.dmi'
...
/obj/machinery/trading_card_button/proc/setup_radial()
	...
	"Set Mana" = image(icon = '../assets/icons/hud/radial.dmi', icon_state = "radial_set_mana"),
	"Set Mana Slots" = image(icon = '../assets/icons/hud/radial.dmi', icon_state = "radial_set_slots"),
	"Next Turn" = image(icon = '../assets/icons/hud/radial.dmi', icon_state = "radial_next"),
	)
...
/obj/machinery/trading_card_button/health/setup_radial()
	...
	"Set Life" = image(icon = '../assets/icons/hud/radial.dmi', icon_state = "radial_set_life"),
	"Inflict Damage" = image(icon = '../assets/icons/hud/radial.dmi', icon_state = "radial_damage"),
	)
	return radial_choices
...
/obj/effect/trading_card_panel
	name = "mana panel"
	icon = '../assets/icons/obj/toys/tcgmisc_large.dmi'
	...
	var/gem_icon_file = '../assets/icons/obj/toys/tcgmisc.dmi'
