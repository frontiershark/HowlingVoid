...
/mob/dead/new_player/proc/AttemptLateSpawn(rank)
	...
	var/captain_sound = '../assets/sound/announcer/notice/notice2.ogg'
	...
	if(is_captain_job(job))
		...
		captain_sound = ANNOUNCER_DEPARTMENTAL // NOVA EDIT CHANGE - Announcer Sounds - ORIGINAL: captain_sound = '../assets/sound/announcer/announcement/announce.ogg'
