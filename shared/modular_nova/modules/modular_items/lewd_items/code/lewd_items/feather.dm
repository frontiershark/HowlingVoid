...
/obj/item/tickle_feather/attack(mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	playsound_if_pref(loc, \
		pick(
			'../assets/sound/items/handling/cloth/cloth_drop1.ogg', // I duplicate this part of code because im useless shitcoder that can't make it work properly without tons of repeating code blocks
			'../assets/sound/items/handling/cloth/cloth_pickup1.ogg', // If you can make it better - go ahead, modify it, please.
			'../assets/sound/items/handling/cloth/cloth_pickup1.ogg',
		), 70, 1, -1)
