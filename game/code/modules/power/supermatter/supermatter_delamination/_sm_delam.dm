...
/datum/sm_delam/proc/delam_progress(obj/machinery/power/supermatter_crystal/sm)
	...
	if(sm.damage_archived - sm.damage > SUPERMATTER_FAST_HEALING_RATE && sm.damage_archived >= sm.emergency_point) // Fast healing, engineers probably have it all sorted
		...
		playsound(sm, '../assets/sound/machines/terminal/terminal_alert.ogg', 75)
		return FALSE
	...
	switch(sm.get_status())
		if(SUPERMATTER_DELAMINATING)
			...
			alert_sound_to_playing('../assets/sound/effects/alert.ogg', override_volume = TRUE)
			// NOVA EDIT ADDITION END
			playsound(sm, '../assets/sound/announcer/alarm/bloblarm.ogg', 100, FALSE, 40, 30, falloff_distance = 10)
		if(SUPERMATTER_EMERGENCY)
			// NOVA EDIT ADDITION
			alert_sound_to_playing('modular_nova/master_files/sound/effects/reactor/core_overheating.ogg', override_volume = TRUE)
			alert_sound_to_playing('../assets/sound/announcer/notice/notice1.ogg', override_volume = TRUE)
			// NOVA EDIT ADDITION END
			playsound(sm, '../assets/sound/machines/engine_alert/engine_alert1.ogg', 100, FALSE, 30, 30, falloff_distance = 10)
		if(SUPERMATTER_DANGER)
			playsound(sm, '../assets/sound/machines/engine_alert/engine_alert2.ogg', 100, FALSE, 30, 30, falloff_distance = 10)
