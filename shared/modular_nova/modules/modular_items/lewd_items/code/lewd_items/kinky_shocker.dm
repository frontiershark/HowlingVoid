...
/obj/item/kinky_shocker/proc/toggle_shocker(mob/user)
	if(cell && cell.charge >= cell_hit_cost)
		...
		playsound_if_pref(user, shocker_on ? '../assets/sound/items/weapons/magin.ogg' : '../assets/sound/items/weapons/magout.ogg', 40, TRUE)
	else
		shocker_on = FALSE
		if(!cell)
...
/obj/item/kinky_shocker/attack(mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	playsound_if_pref(loc, '../assets/sound/items/weapons/taserhit.ogg', 70, 1, -1)
	...
	playsound_if_pref(loc, '../assets/sound/items/weapons/taserhit.ogg')
	if(target.stat == DEAD)
		return
	if(prob(80))
