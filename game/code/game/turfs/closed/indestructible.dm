...
/turf/closed/indestructible/weeb
	...
	var/static/mutable_appearance/indestructible_paper = mutable_appearance('../assets/icons/obj/smooth_structures/structure_variations.dmi',icon_state = "paper-whole", layer = CLOSED_TURF_LAYER - 0.1)
...
/turf/closed/indestructible/splashscreen
	...
	icon = '../assets/icons/blanks/blank_title.png'
	icon_state = ""
...
/turf/closed/indestructible/reinforced
	...
	icon = '../assets/icons/turf/walls/reinforced_wall.dmi'
...
/turf/closed/indestructible/riveted
	icon = '../assets/icons/turf/walls/riveted.dmi'
...
/turf/closed/indestructible/riveted/plastinum
	...
	icon = '../assets/icons/turf/walls/plastinum_wall.dmi'
...
/turf/closed/indestructible/riveted/plastinum/nodiagonal
	icon = MAP_SWITCH('../assets/icons/turf/walls/plastinum_wall.dmi', '../assets/icons/turf/walls/misc_wall.dmi')
...
/turf/closed/indestructible/fakeglass
	name = "window"
	icon = MAP_SWITCH('../assets/icons/obj/smooth_structures/reinforced_window.dmi', '../assets/icons/obj/smooth_structures/structure_variations.dmi')
...
/turf/closed/indestructible/fakeglass/Initialize(mapload)
	. = ..()
	underlays += mutable_appearance('../assets/icons/obj/structures.dmi', "grille", layer - 0.01, src) //add a grille underlay
	underlays += mutable_appearance('../assets/icons/turf/floors.dmi', "plating", layer - 0.02, src) //add the plating underlay, below the grille
...
/turf/closed/indestructible/opsglass/Initialize(mapload)
	. = ..()
	underlays += mutable_appearance('../assets/icons/obj/structures.dmi', "grille", layer - 0.01, src)
	underlays += mutable_appearance('../assets/icons/turf/floors.dmi', "plating", layer - 0.02, src)
...
/turf/closed/indestructible/riveted/hierophant
	...
	icon = '../assets/icons/turf/walls/hierophant_wall.dmi'
...
/turf/closed/indestructible/riveted/hierophant/update_overlays()
	. = ..()
	. += emissive_appearance('../assets/icons/turf/walls/hierophant_wall_e.dmi', icon_state, src)
...
/turf/closed/indestructible/resin/membrane/Initialize(mapload)
	. = ..()
	underlays += mutable_appearance('../assets/icons/turf/floors.dmi', "engine", layer - 0.01, src) // add the reinforced floor underneath
...
/turf/closed/indestructible/grille/Initialize(mapload)
	. = ..()
	underlays += mutable_appearance('../assets/icons/turf/floors.dmi', "plating", layer - 0.01, src)
...
/turf/closed/indestructible/meat
	...
	icon = '../assets/icons/turf/walls/meat_wall.dmi'
