/obj/machinery/big_manipulator
	...
	icon = '../assets/icons/obj/machines/big_manipulator_parts/big_manipulator_core.dmi'
	icon_state = "core"
...
/obj/machinery/big_manipulator/proc/update_hud()
	...
	main_hud.appearance = mutable_appearance('../assets/icons/effects/interaction_points.dmi', null, ABOVE_ALL_MOB_LAYER, src, GAME_PLANE)
	...
	for(var/i in 1 to length(pickup_points))
		...
		if(target_turf)
			var/mutable_appearance/point_appearance = mutable_appearance('../assets/icons/effects/interaction_points.dmi', "pickup_[i]", ABOVE_ALL_MOB_LAYER, src, GAME_PLANE)
	...
	for(var/i in 1 to length(dropoff_points))
		...
		var/turf/target_turf = point.interaction_turf
		if(target_turf)
			var/mutable_appearance/point_appearance = mutable_appearance('../assets/icons/effects/interaction_points.dmi', "dropoff_[i]", ABOVE_ALL_MOB_LAYER, src, GAME_PLANE)
			var/turf/manip_turf = get_turf(src)
			point_appearance.pixel_x = (target_turf.x - manip_turf.x) * 32
			point_appearance.pixel_y = (target_turf.y - manip_turf.y) * 32
			point_overlays += point_appearance
