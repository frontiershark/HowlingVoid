...
/obj/item/circuit_component/soundemitter/populate_options()
	var/static/component_options = list(
		"Buzz" = '../assets/sound/machines/buzz/buzz-sigh.ogg',
		"Buzz Twice" = '../assets/sound/machines/buzz/buzz-two.ogg',
		"Chime" = '../assets/sound/machines/chime.ogg',
		"Honk" = '../assets/sound/items/bikehorn.ogg',
		"Ping" = '../assets/sound/machines/ping.ogg',
		"Sad Trombone" = '../assets/sound/misc/sadtrombone.ogg',
		"Warn" = '../assets/sound/machines/warning-buzzer.ogg',
		"Slow Clap" = '../assets/sound/machines/slowclap.ogg',
		"Moth Buzz" = '../assets/sound/mobs/humanoids/moth/scream_moth.ogg',
		"Squeak" = '../assets/sound/items/toy_squeak/toysqueak1.ogg',
		"Rip" = '../assets/sound/items/poster/poster_ripped.ogg',
		"Coinflip" = '../assets/sound/items/coinflip.ogg',
		"Megaphone" = '../assets/sound/items/megaphone.ogg',
		"Warpwhistle" = '../assets/sound/effects/magic/warpwhistle.ogg',
		"Hiss" = '../assets/sound/mobs/non-humanoids/hiss/hiss1.ogg',
		"Lizard" = '../assets/sound/mobs/humanoids/lizard/lizard_scream_1.ogg',
		"Flashbang" = '../assets/sound/items/weapons/flashbang.ogg',
		"Flash" = '../assets/sound/items/weapons/flash.ogg',
		"Whip" = '../assets/sound/items/weapons/whip.ogg',
		"Laugh Track" = '../assets/sound/items/sitcom_laugh/sitcomLaugh2.ogg',
		"Gavel" = '../assets/sound/items/gavel.ogg',
	)
