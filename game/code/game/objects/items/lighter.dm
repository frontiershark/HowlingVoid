...
/obj/item/lighter/proc/set_lit(new_lit)
	...
	if(lit)
		...
		if(fancy)
			playsound(src.loc , '../assets/sound/items/lighter/zippo_on.ogg', 100, 1)
		else
			playsound(src.loc, '../assets/sound/items/lighter/lighter_on.ogg', 100, 1)
		if(isliving(loc))
		...
		if(fancy)
			playsound(src.loc , '../assets/sound/items/lighter/zippo_off.ogg', 100, 1)
		else
			playsound(src.loc , '../assets/sound/items/lighter/lighter_off.ogg', 100, 1)
	set_light_on(lit)
	update_appearance()
