/datum/action/cooldown/mob_cooldown/blood_worm
	...
	background_icon = '../assets/icons/mob/actions/backgrounds.dmi'
	background_icon_state = "bg_demon"

	button_icon = '../assets/icons/mob/actions/actions_blood_worm.dmi'

	overlay_icon = '../assets/icons/mob/actions/backgrounds.dmi'
	overlay_icon_state = "bg_demon_border"
	active_overlay_icon_state = "bg_spell_border_active_red"

	ranged_mousepointer = '../assets/icons/effects/mouse_pointers/weapon_pointer.dmi'
