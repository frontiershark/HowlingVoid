...
/obj/structure/blob/special/node/update_overlays()
	. = ..()
	var/mutable_appearance/blob_overlay = mutable_appearance('../assets/icons/mob/nonhuman-player/blob.dmi', "blob")
	if(overmind)
	...
	. += blob_overlay
	. += mutable_appearance('../assets/icons/mob/nonhuman-player/blob.dmi', "blob_node_overlay")
