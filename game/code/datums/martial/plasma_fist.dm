...
/datum/martial_art/plasma_fist/proc/Tornado(mob/living/attacker, mob/living/defender)
	...
	dance_rotate(attacker, CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(playsound), attacker, '../assets/sound/items/weapons/punch1.ogg', 15, TRUE, -1))
...
/datum/martial_art/plasma_fist/proc/Throwback(mob/living/attacker, mob/living/defender)
	...
	playsound(defender, '../assets/sound/items/weapons/punch1.ogg', 50, TRUE, -1)
...
/datum/martial_art/plasma_fist/proc/Apotheosis(mob/living/user, mob/living/target)
	...
	playsound(boomspot, '../assets/sound/items/weapons/punch1.ogg', 50, TRUE, -1)
