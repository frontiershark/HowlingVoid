...
/mob/living/basic/bot/hygienebot
	...
	var/static/mutable_appearance/water_overlay = mutable_appearance('../assets/icons/mob/silicon/aibots.dmi', "hygienebot-water")
	///Visual overlay of the bot commiting warcrimes.
	var/static/mutable_appearance/fire_overlay = mutable_appearance('../assets/icons/mob/silicon/aibots.dmi', "hygienebot-fire")
	///announcements we say when we find a target
	var/static/list/found_announcements = list(
		HYGIENEBOT_VOICED_UNHYGIENIC = '../assets/sound/mobs/non-humanoids/hygienebot/unhygienicclient.ogg',
	)
	///announcements we say when the target keeps moving away
	var/static/list/threat_announcements = list(
		HYGIENEBOT_VOICED_THREAT_AIRLOCK = '../assets/sound/mobs/non-humanoids/hygienebot/dragyouout.ogg',
		HYGIENEBOT_VOICED_FOUL_SMELL = '../assets/sound/mobs/non-humanoids/hygienebot/foulsmelling.ogg',
		HYGIENEBOT_VOICED_TROGLODYTE = '../assets/sound/mobs/non-humanoids/hygienebot/troglodyte.ogg',
		HYGIENEBOT_VOICED_GREEN_CLOUD = '../assets/sound/mobs/non-humanoids/hygienebot/greencloud.ogg',
		HYGIENEBOT_VOICED_ARSEHOLE = '../assets/sound/mobs/non-humanoids/hygienebot/letmeclean.ogg',
		HYGIENEBOT_VOICED_THREAT_ARTERIES = '../assets/sound/mobs/non-humanoids/hygienebot/cutarteries.ogg',
		HYGIENEBOT_VOICED_STOP_RUNNING = '../assets/sound/mobs/non-humanoids/hygienebot/stoprunning.ogg',
	)
	///announcements we say after we have cleaned our target
	var/static/list/cleaned_announcements = list(
		HYGIENEBOT_VOICED_FUCKING_FINALLY = '../assets/sound/mobs/non-humanoids/hygienebot/finally.ogg',
		HYGIENEBOT_VOICED_THANK_GOD = '../assets/sound/mobs/non-humanoids/hygienebot/thankgod.ogg',
		HYGIENEBOT_VOICED_DEGENERATE = '../assets/sound/mobs/non-humanoids/hygienebot/degenerate.ogg',
	)
