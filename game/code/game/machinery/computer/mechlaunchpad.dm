...
/obj/machinery/computer/mechpad/proc/random_beeps(mob/user, time = 0, mintime = 0, maxtime = 1)
	var/static/list/beep_sounds = list('../assets/sound/machines/terminal/terminal_prompt_confirm.ogg', '../assets/sound/machines/terminal/terminal_prompt_deny.ogg', '../assets/sound/machines/terminal/terminal_error.ogg', '../assets/sound/machines/terminal/terminal_select.ogg', '../assets/sound/machines/terminal/terminal_success.ogg')
	var/time_to_spend = 0
	var/orig_time = time
	while(time > 0)
...
/obj/machinery/computer/mechpad/proc/try_launch(mob/user, obj/machinery/mechpad/where)
	...
	playsound(connected_mechpad, '../assets/sound/machines/beep/triple_beep.ogg', 50, TRUE)
