/obj/machinery/atmospherics/pipe/bridge_pipe
	icon = '../assets/icons/obj/pipes_n_cables/bridge_pipe.dmi'
...
/obj/machinery/atmospherics/pipe/bridge_pipe/update_overlays()
	. = ..()
	var/mutable_appearance/center = mutable_appearance('../assets/icons/obj/pipes_n_cables/bridge_pipe.dmi', "bridge_center")
