/datum/species/lizard
	...
	*/ // NOVA EDIT REMOVAL END
	...
	death_sound = '../assets/sound/mobs/humanoids/lizard/deathsound.ogg'
...
/datum/species/lizard/get_scream_sound(mob/living/carbon/human/lizard)
	return pick(
		...
		'../assets/sound/mobs/humanoids/lizard/lizard_scream_2.ogg',
		'../assets/sound/mobs/humanoids/lizard/lizard_scream_3.ogg',
	)

/datum/species/lizard/get_cough_sound(mob/living/carbon/human/lizard)
	if(lizard.physique == FEMALE)
		return pick(
			'../assets/sound/mobs/humanoids/human/cough/female_cough1.ogg',
			'../assets/sound/mobs/humanoids/human/cough/female_cough2.ogg',
			'../assets/sound/mobs/humanoids/human/cough/female_cough3.ogg',
			'../assets/sound/mobs/humanoids/human/cough/female_cough4.ogg',
			'../assets/sound/mobs/humanoids/human/cough/female_cough5.ogg',
			'../assets/sound/mobs/humanoids/human/cough/female_cough6.ogg',
		)
	return pick(
		'../assets/sound/mobs/humanoids/human/cough/male_cough1.ogg',
		'../assets/sound/mobs/humanoids/human/cough/male_cough2.ogg',
		'../assets/sound/mobs/humanoids/human/cough/male_cough3.ogg',
		'../assets/sound/mobs/humanoids/human/cough/male_cough4.ogg',
		'../assets/sound/mobs/humanoids/human/cough/male_cough5.ogg',
		'../assets/sound/mobs/humanoids/human/cough/male_cough6.ogg',
	)
...
/datum/species/lizard/get_cry_sound(mob/living/carbon/human/lizard)
	if(lizard.physique == FEMALE)
		return pick(
			'../assets/sound/mobs/humanoids/human/cry/female_cry1.ogg',
			'../assets/sound/mobs/humanoids/human/cry/female_cry2.ogg',
		)
	return pick(
		'../assets/sound/mobs/humanoids/human/cry/male_cry1.ogg',
		'../assets/sound/mobs/humanoids/human/cry/male_cry2.ogg',
		'../assets/sound/mobs/humanoids/human/cry/male_cry3.ogg',
	)


/datum/species/lizard/get_sneeze_sound(mob/living/carbon/human/lizard)
	if(lizard.physique == FEMALE)
		return '../assets/sound/mobs/humanoids/human/sneeze/female_sneeze1.ogg'
	return '../assets/sound/mobs/humanoids/human/sneeze/male_sneeze1.ogg'

/datum/species/lizard/get_laugh_sound(mob/living/carbon/human/lizard)
	return '../assets/sound/mobs/humanoids/lizard/lizard_laugh1.ogg'
...
/datum/species/lizard/get_sniff_sound(mob/living/carbon/human/lizard)
	if(lizard.physique == FEMALE)
		return '../assets/sound/mobs/humanoids/human/sniff/female_sniff.ogg'
	return '../assets/sound/mobs/humanoids/human/sniff/male_sniff.ogg'
...
/datum/species/lizard/get_hiss_sound(mob/living/carbon/human/lizard)
	return '../assets/sound/mobs/humanoids/lizard/lizard_hiss.ogg'
