...
/datum/martial_art/cqc/proc/Slam(mob/living/attacker, mob/living/defender)
	...
	playsound(attacker, '../assets/sound/items/weapons/slam.ogg', 50, TRUE, -1)
...
/datum/martial_art/cqc/proc/Kick(mob/living/attacker, mob/living/defender)
	...
	if(defender.body_position == LYING_DOWN && !defender.IsUnconscious() && defender.get_stamina_loss() >= 100)
		...
		playsound(attacker, '../assets/sound/items/weapons/genhit1.ogg', 50, TRUE, -1)
		...
		playsound(attacker, '../assets/sound/items/weapons/cqchit1.ogg', 50, TRUE, -1)
...
/datum/martial_art/cqc/proc/Consecutive(mob/living/attacker, mob/living/defender)
	...
	playsound(defender, '../assets/sound/items/weapons/cqchit2.ogg', 50, TRUE, -1)
...
/datum/martial_art/cqc/harm_act(mob/living/attacker, mob/living/defender)
	...
	playsound(defender, (picked_hit_type == "kick" || picked_hit_type == "stomp") ? '../assets/sound/items/weapons/cqchit2.ogg' : '../assets/sound/items/weapons/cqchit1.ogg', 50, TRUE, -1)
...
/datum/martial_art/cqc/disarm_act(mob/living/attacker, mob/living/defender)
	...
	if(prob(65) && (defender.stat == CONSCIOUS || !defender.IsParalyzed() || !restraining_mob?.resolve()))
		...
		playsound(defender, '../assets/sound/items/weapons/cqchit1.ogg', 50, TRUE, -1)
	...
	playsound(defender, '../assets/sound/items/weapons/punchmiss.ogg', 25, TRUE, -1)
