...
/obj/item/boulder/proc/manual_process(obj/item/weapon, mob/living/user, override_speed_multiplier, continued = FALSE)
	...
	// Handle user conditions/override conditions.
		...
		playsound(src, '../assets/sound/effects/rock/rocktap1.ogg', 50)
		if(!continued)
	...
	if(durability <= 0)
		...
		playsound(src, '../assets/sound/effects/rock/rock_break.ogg', 50)
...
/obj/item/boulder/proc/break_apart()
	if(length(contents))
		...
		playsound(loc, '../assets/sound/effects/pickaxe/picaxe1.ogg', 60, FALSE)
