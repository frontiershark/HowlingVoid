/datum/mod_theme/policing
	...
	variants = list(
		"policing" = list(
			MOD_ICON_OVERRIDE = 'modularhowling_void/modules/police_modsuit/icons/mod.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modularhowling_void/modules/police_modsuit/icons/wornmod.dmi',
...
/obj/item/mod/module/status_readout/policing_operational
	...
	display_time = TRUE
	death_sound = 'modularhowling_void/modules/police_modsuit/sound/flatline.ogg'
